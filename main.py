...
app, rt = fast_app(
    ...
    hdrs=(
        ...
        Link(
            rel="stylesheet",
            href="https://fonts.googleapis.com/css2?family=Grape+Nuts&family=Rubik+Glitch+Pop&family=Plus+Jakarta+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,400;1,500&family=JetBrains+Mono:wght@400;500;600&display=swap"
        ),
        Link(
            rel="stylesheet",
